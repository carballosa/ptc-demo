  ...
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddAuthorization(cfg =>
        // NOTE: The policy name must match the parameter passed to
        //  Controller in the attribute [Authorize(Policy = "CanAccessProducts")]
        cfg.AddPolicy("CanAccessProducts",
          // NOTE: The claim type and value are case-sensitive and
          //  must match the values from the database
